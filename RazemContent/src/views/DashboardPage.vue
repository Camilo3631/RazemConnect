      ...
      <div :class="[
        ...
        <div class="flex items-center justify-between border-b border-slate-700 flex-shrink-0">
         ...
         <div class="flex-1 overflow-y-auto">
          <ChatPreview
            ...
            <p v-if="filteredChats.length === 0" class="text-slate-500 text-sm text-center py-6 px-4">
        ...
        <div class="flex-1 overflow-y-auto p-4 space-y-3">
           <template v-if="selectedChat">
            ...
            />
            <p v-if="messages.length === 0" class="text-slate-500 text-sm text-center">
    ...
    >
      <div class="bg-slate-800 rounded-2xl p-5 w-full max-w-sm">
        <div class="flex items-center justify-between mb-4">
          <h2 class="text-white font-semibold text-lg">Agregar contacto</h2>
          <button @click="showAddContact = false" class="text-slate-400 hover:text-white">
        ...
        <div class="max-h-64 overflow-y-auto space-y-2">
          ...
          >
            ...
            <p class="text-white text-sm flex-1 truncate">{{ user.username }}</p>
            <button
          ...
          <p v-if="filteredUsers.length === 0" class="text-slate-500 text-sm text-center py-4">
...
import { BiArrowLeft, BiPlusLg, BiXLg } from 'oh-vue-icons/icons';

addIcons(BiArrowLeft, BiPlusLg, BiXLg)
